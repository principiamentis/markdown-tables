declare module 'markdown-tables' {
   ...
   */
  export function markdownTables(input: string, options?: Options & { allSheets?: false }): Promise<string>;
  export function markdownTables(input: string, options?: Options & { allSheets: true }): Promise<string[]>;
}
